           ...
           <div className="flex items-center gap-3">
             ...
             {pdfBytes && (
               <>
                 ...
                 <button onClick={() => pdfBytes && downloadBytes(pdfBytes, "edited")} className="px-5 py-2.5 rounded-lg text-sm font-bold flex items-center gap-2 transition shadow-lg bg-black text-white hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-200"><Download size={16} /> Export PDF</button>
               </>
             )}
           </div>
        </div>
